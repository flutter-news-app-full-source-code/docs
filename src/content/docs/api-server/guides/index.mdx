...
<CardGrid>
  ...
  <Card title="Managing the Admin Account" icon="user-cog">
    Learn how to set, change, or recover the primary administrator account.
    [Read more &rarr;](/docs/api-server/guides/managing-admin-account/)
  </Card>
</CardGrid>

...
6.  **Configure the Environment**
    ...
    **Firebase Keys (from `google-services.json` & `GoogleService-Info.plist`):**
    ...
    <Aside type="tip">
        For an even easier workflow, you can configure your editor to run these commands for you. Check out the **Configuring VS Code Launch Environments** guide.
    </Aside>
...
7.  **Run the Application**
    ...
    <Aside>
    For the `development` environment, you must have the API Server running locally first.
    </Aside>

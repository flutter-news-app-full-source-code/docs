    ...
    "configurations": [
        ...
        },
        {
            ...
            "args": [
                ...
                // --- OneSignal ---
                "--dart-define=ONE_SIGNAL_ANDROID_APP_ID=YOUR_DEV_ONESIGNAL_ANDROID_APP_ID",
                "--dart-define=ONE_SIGNAL_IOS_APP_ID=YOUR_DEV_ONESIGNAL_IOS_APP_ID",

                // --- Firebase (Android) ---
                "--dart-define=FIREBASE_ANDROID_API_KEY=YOUR_DEV_FIREBASE_ANDROID_API_KEY",
                "--dart-define=FIREBASE_ANDROID_APP_ID=YOUR_DEV_FIREBASE_ANDROID_APP_ID",

                // --- Firebase (iOS) ---
                "--dart-define=FIREBASE_IOS_API_KEY=YOUR_DEV_FIREBASE_IOS_API_KEY",
                "--dart-define=FIREBASE_IOS_APP_ID=YOUR_DEV_FIREBASE_IOS_APP_ID",

                // --- Firebase (Shared) ---
                "--dart-define=FIREBASE_MESSAGING_SENDER_ID=YOUR_DEV_FIREBASE_MESSAGING_SENDER_ID",
                "--dart-define=FIREBASE_PROJECT_ID=YOUR_DEV_FIREBASE_PROJECT_ID",
                "--dart-define=FIREBASE_STORAGE_BUCKET=YOUR_DEV_FIREBASE_STORAGE_BUCKET"
            ]
        },
        {

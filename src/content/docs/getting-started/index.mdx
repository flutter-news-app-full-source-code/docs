...
<CardGrid>
    ...
    <Card title="4. Learn to Customize" icon="puzzle">
        Once you have the toolkit running, you'll want to learn how to modify it. This section covers the critical workflow for hosting your own versions of the shared packages.
